package co.jmurillo.recursividad.ejemplo;

import co.jmurillo.recursividad.ejemplo.models.Componente;
...
public class EjemploRecursividad {
    public static void main(String[] args) {
        ...
        Componente ventilador = new Componente("Ventilador GPU");
        ...
        Componente gpuRam2 = new Componente("$GB Ram");
        ...
        pc.addComponente(poder)
                ...
                .addComponente(new Componente("Mause"));
